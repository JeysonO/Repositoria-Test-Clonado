 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://ws.wsiopidetramite.segdi.gob.pe/}ioTipoDocumentoTramite" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetTipoDocumentoResponse {
    ...
    protected List<IoTipoDocumentoTramite> _return;
     ...
     * {@link IoTipoDocumentoTramite }
     * 
     * 
     */
    public List<IoTipoDocumentoTramite> getReturn() {
        if (_return == null) {
            _return = new ArrayList<IoTipoDocumentoTramite>();
        }
        return this._return;
    }
